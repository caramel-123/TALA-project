...
const gapFactors = [
  { factor: 'Remote/Island Access', contribution: 85, confidence: 'high' },
  { factor: 'Teacher Specialization Gap', contribution: 72, confidence: 'high' },
  { factor: 'Resource Availability', contribution: 68, confidence: 'moderate' },
  { factor: 'Training Infrastructure', contribution: 55, confidence: 'moderate' },
  { factor: 'Connectivity Issues', contribution: 48, confidence: 'high' },
];
