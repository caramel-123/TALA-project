...
const trainingReachData = [
  { program: 'Math Problem Solving', reach: 8500 },
  { program: 'Science Inquiry', reach: 7200 },
  { program: 'Language Strategies', reach: 6800 },
  { program: 'Design Thinking', reach: 5900 },
  { program: 'Assessment', reach: 5200 },
];

const specializationData = [
  { name: 'Science', value: 35, color: '#2E6DA4' },
  { name: 'Mathematics', value: 30, color: '#A8C8E8' },
  { name: 'Languages', value: 20, color: '#E8C94F' },
  { name: 'Other', value: 15, color: '#D8D8D8' },
];

const participationTrend = [
  { month: 'Jan', teachers: 2800 },
  { month: 'Feb', teachers: 3200 },
  { month: 'Mar', teachers: 3600 },
  { month: 'Apr', teachers: 4100 },
];
